defmodule PetalComponents.ChatBubble do
  ...
  attr(:file_name, :string,
    default: "Petal Components Terms & Conditions",
  ...
  # Image attributes
  attr(:image_src, :string,
    default: "https://images.unsplash.com/photo-1562664377-709f2c337eb2",
    doc: "URL of the attached image"
  )
  ...
  attr(:url_title, :string,
    default: "Welcome to Petal Components",
    doc: "title of the URL preview"
  )

  attr(:url_description, :string,
    default: "A versatile set of beautifully styled components",
    doc: "description for the URL preview"
  )

  attr(:url_image, :string,
    default: "https://petal.build/images/favicon.png",
    doc: "image for the URL preview"
  )

  attr(:url_domain, :string, default: "github.com", doc: "domain name for the URL")

  def chat_bubble(%{kind: :chat_bubble, variant: :default} = assigns) do
    assigns =
      assigns
  ...
  def chat_bubble(%{kind: :voice_note, variant: :default} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :file_attachment, variant: :default} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :image_attachment, variant: :default} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :image_gallery, variant: :default} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :url_preview_sharing, variant: :default} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
    ...
    <div {@rest} class={["pc-chat-bubble", "pc-chat-bubble--url-preview", @class]}>
      <div class="flex items-start gap-2.5">
        ...
        <div class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
          ...
          <a
            href={@url}
            class="bg-gray-50 dark:bg-gray-600 rounded-xl p-4 mb-2 hover:bg-gray-200 dark:hover:bg-gray-500 cursor-pointer"
          >
            ...
            <div class="w-full p-2.5 bg-white dark:bg-gray-800">
              ...
              <p class="text-xs font-normal text-gray-500 dark:text-gray-400 my-1">
                {@url_description}
              </p>
              <span class="flex items-center text-xs font-normal text-gray-500 dark:text-gray-400">
                ...
                >
                  <path
                    fill-rule="evenodd"
                    d="M4.083 8.222L8.364 3.94a1.59 1.59 0 0 1 2.25 0l4.279 4.28a1.59 1.59 0 0 1 0 2.251l-4.28 4.28a1.59 1.59 0 0 1-2.25 0l-4.28-4.28a1.591 1.591 0 0 1 0-2.251z"
                  />
                </svg>
                {@url_domain}
              </span>
  ...
  def chat_bubble(%{kind: :chat_bubble, variant: :outline} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :voice_note, variant: :outline} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:time, assigns[:time])
  ...
  def chat_bubble(%{kind: :file_attachment, variant: :outline} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:time, assigns[:time])
  ...
  def chat_bubble(%{kind: :image_attachment, variant: :outline} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
      ...
      <div class="flex items-start gap-2.5">
        ...
        <div class="flex flex-col gap-1 w-full max-w-[326px]">
          ...
          <div class="flex flex-col w-full leading-1.5 p-2 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
            <div
              x-data="{ showTooltip: false }"
              class="group relative border-gray-200 bg-gray-100 p-2 rounded-lg dark:bg-gray-700"
            >
              <div class="absolute w-full h-full bg-gray-900/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                <button
                  @mouseenter="showTooltip = true"
  ...
  def chat_bubble(%{kind: :image_gallery, variant: :outline} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :url_preview_sharing, variant: :outline} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
      ...
      <div class="flex items-start gap-2.5">
        ...
        <div class="flex flex-col gap-1 w-full max-w-[320px]">
          ...
          <div class="flex flex-col w-full leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
            ...
            <a
              href={@url}
              class="flex flex-col items-start hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer"
            >
  ...
  def chat_bubble(%{kind: :chat_bubble, variant: :clean} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :voice_note, variant: :clean} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:time, assigns[:time])
  ...
  def chat_bubble(%{kind: :file_attachment, variant: :clean} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:time, assigns[:time])
  ...
  def chat_bubble(%{kind: :image_attachment, variant: :clean} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :image_gallery, variant: :clean} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
  ...
  def chat_bubble(%{kind: :url_preview_sharing, variant: :clean} = assigns) do
    assigns =
      assigns
      |> assign(:author, assigns[:author])
      |> assign(:message, assigns[:message])
    ...
    <div {@rest} class={["pc-chat-bubble", "pc-chat-bubble--clean-url-preview", @class]}>
      <div class="flex items-start gap-2.5">
        ...
        <div class="flex flex-col w-full max-w-[320px] leading-1.5">
          ...
          <a
            href={@url}
            class="flex flex-col items-start my-2.5 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer"
          >
            <img class="w-full h-auto object-cover" src={@url_image} alt="" />
            <div class="w-full p-2.5 bg-white dark:bg-gray-800">
              <p class="text-sm font-medium text-gray-900 dark:text-white">{@url_title}</p>
