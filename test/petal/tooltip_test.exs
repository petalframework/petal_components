defmodule PetalComponents.TooltipTest do
  ...
  test "bubble carries the given id for aria-describedby wiring" do
    assigns = %{}

    html =
      rendered_to_string(~H"""
      <.tooltip id="save-tip" label="Save">
        <button aria-describedby="save-tip">Trigger</button>
      </.tooltip>
      """)

    assert html =~ ~s(id="save-tip")
    assert html =~ ~s(aria-describedby="save-tip")
  end

  test "bubble id is autogenerated when not given" do
    assigns = %{}
