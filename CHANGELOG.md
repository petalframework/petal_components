...
- `language_select/1` graduates from Petal Pro: the locale flag dropdown,
  now a free composition of `dropdown/1`. Plain links carry `?locale=`
  ...
  unknown `current_locale` falls back to a language glyph instead of
  raising.
